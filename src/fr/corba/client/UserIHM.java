...
public class UserIHM {
	...
	public boolean subscribe() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Nom d�j� existant", "Erreur", JOptionPane.ERROR_MESSAGE);
	...
	public UserIHM(String[] args) {
		initializeORB(args);
		int retour = JOptionPane.showOptionDialog(null, "Avez-vous d�j� un compte ?", "Bienvenue", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
		switch (retour) {
		// Connexion
		case 0:
